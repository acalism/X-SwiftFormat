...
protocol NSAnimatedButtonDelegate: class {
	func animatedButtonMouseEntered(button: NSAnimatedButton)
	func animatedButtonMouseExited(button: NSAnimatedButton)
}

class NSAnimatedButton: NSButton {

	weak var delegate: NSAnimatedButtonDelegate?
